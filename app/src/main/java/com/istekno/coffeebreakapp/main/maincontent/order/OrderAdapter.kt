...
class OrderAdapter(private val listOrder : ArrayList<OrderResponse.Data>,
                   private val onListOrderClickListener : OnListOrderClickListenerr): RecyclerView.Adapter<OrderAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        return ListViewHolder(DataBindingUtil.inflate(LayoutInflater.from(parent.context), R.layout.item_order, parent, false))
    }
